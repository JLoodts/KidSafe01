...
import com.jollylemming.kidsafe01.fragments.ActivityLogFragment;
import com.jollylemming.kidsafe01.fragments.AppsFragment;
import com.jollylemming.kidsafe01.fragments.LocationFragment;
import com.jollylemming.kidsafe01.models.App;

import java.util.ArrayList;

import static com.jollylemming.kidsafe01.activities.ParentSignedInActivity.APPS_EXTRA;
		...
		bottomNav.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
			...
			public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
				...
				if (itemId == R.id.navApps) {
				 ...
				 //error: constant expression required: case R.id.navApps:
