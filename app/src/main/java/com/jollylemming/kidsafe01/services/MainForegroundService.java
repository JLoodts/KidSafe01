package com.jollylemming.kidsafe01.services;
...
import com.jollylemming.kidsafe01.activities.BlockedAppActivity;
import com.jollylemming.kidsafe01.activities.ChildSignedInActivity;
import com.jollylemming.kidsafe01.broadcasts.AppInstalledReceiver;
import com.jollylemming.kidsafe01.broadcasts.AppRemovedReceiver;
import com.jollylemming.kidsafe01.broadcasts.PhoneStateReceiver;
import com.jollylemming.kidsafe01.broadcasts.ScreenTimeReceiver;
import com.jollylemming.kidsafe01.broadcasts.SmsReceiver;
import com.jollylemming.kidsafe01.models.App;
...
import static com.jollylemming.kidsafe01.NotificationChannelCreator.CHANNEL_ID;
...
public class MainForegroundService extends Service {
	...
	public static final String BLOCKED_APP_NAME_EXTRA = "com.jollylemming.kidsafe01.services.BLOCKED_APP_NAME_EXTRA";
	...
	private void setFence(DataSnapshot dataSnapshot) {
		final com.jollylemming.kidsafe01.models.Location childLocation = dataSnapshot.getValue(com.jollylemming.kidsafe01.models.Location.class);
	...
	private String getLollipopForegroundAppPackageName() {
		...
		try {
			...
			for (UsageStats stats : foregroundApps) {
                /*if (i == 0 && !"com.jollylemming.kidsafe01".equals(stats.getPackageName())) {
